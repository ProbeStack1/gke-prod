resource "kubernetes_deployment_v1" "probestack_apigee_assessment_service" {
  metadata {
    name      = "probestack-apigee-assessment-service"
    namespace = "secure-production-app"
    labels = {
      app = "probestack-apigee-assessment-service"
    }
  }
  ...
  spec {
    ...
    template {
      ...
      spec {
        ...
        container {
          name  = "probestack-apigee-assessment-service"
          image = var.probestack_apigee_assessment_service_image
          ...
          env {
            ...
            value = "/probestack/v1/apigee/assessment"
          }
          ...
          readiness_probe {
            http_get {
              path = "/probestack/v1/apigee/assessment/actuator/health"
              port = 8080
            }
  ...
  metadata {
    ...
    annotations = {
      ...
      "cloud.google.com/backend-config" = jsonencode({
        default = "probestack-apigee-assessment-service-backend-config"
      })
    }
